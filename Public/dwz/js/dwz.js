				...
				itemDetail : function() {
					...
					function tdHtml(field) {
						...
						case 'date':
							...
							break;
						default:
							html = '<input type="' + field.type + '" name="'
									+ field.name + '" value="'
	...
	$.extend($.fn, {
		comboxSelect : function(options) {
			...
			return this.each(function() {
				...
				$("#op_" + box.attr("id")).find(">li").comboxOption(selector,
						box);
			});
		},
		...
		combox : function() {
			...
			return this.each(function(i) {
				...
				var select = '<div class="combox"><div id="combox_' + cid
						+ '" class="select"'
						+ (ref ? ' ref="' + ref + '"' : '') + '>';
				select += '<a href="javascript:" class="' + $this.attr("class")
