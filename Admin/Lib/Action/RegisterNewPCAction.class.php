<?php
class RegisterNewPCAction extends CommonAction {
    ...
    public function IPsuggest(){
    	$data = array(
    			array('ip'=>'192.168.1.1'),
    			array('ip'=>'192.168.2.1')
    	);
    	$this->ajaxReturn($data);
    }
    public function update() {
    	//B('FilterString');
    	$name=strtolower($this->getActionName());
    	$_POST['IP'] = $_POST['orgLookup_ip'];
    	$model = D ( $name );
