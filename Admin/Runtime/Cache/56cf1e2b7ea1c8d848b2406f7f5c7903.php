<?php if (!defined('THINK_PATH')) exit();?><div class="pageContent">
	...
	<form method="post" action="__URL__/resetPwd?callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
